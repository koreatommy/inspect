...
export default async function FacilitiesPage({
  ...
  let query = supabase
    .from("facilities")
    .select(
      "facility_no, facility_name, road_address, lot_address, install_place_name, duty_type_name, public_private_name, operation_status_name, indoor_outdoor_name",
      { count: "exact" }
    )
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="hidden sm:table-cell">운영 여부</TableHead>
