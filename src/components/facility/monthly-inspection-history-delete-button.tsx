...
import { deleteFacilityMonthlyInspection } from "./monthly-inspection-history-actions"

export function MonthlyInspectionHistoryDeleteButton({
  inspectionId,
  facilityNo,
  inspectionMonth,
}: {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <form action={deleteFacilityMonthlyInspection}>
